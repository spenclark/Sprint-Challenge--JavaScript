...
*/
const displayNames = zooAnimals.forEach(zooAnimals => { return `name: ${zooAnimals.animal_name}`});
...
*/
const populationTotal = zooAnimals.reduce( (total, zooAnimals) => { return total += zooAnimals.population}, 0);
